...
export const metadata: Metadata = {
  title: 'EB-5 Visa Attorney USA | Expert Immigration Lawyer Services',
  description: 'Hire an experienced EB-5 visa attorney in USA for investor immigration, green cards, and global expansion. Trusted legal guidance for successful outcomes.',
  keywords: 'EB-5 Visa Attorney USA, investor visa lawyer, EB-5 green card, regional center, EB-5 investment, immigrant investor, I-526 petition, I-829 petition, investment immigration',
  openGraph: {
